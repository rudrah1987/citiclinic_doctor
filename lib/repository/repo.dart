...
class Repository{
  ...
  Future<SignUpResponse> signUp(String name, String phone,
      String email, String password, String  fb_token, String longitude, String latitude) =>
      apiProvider.signUp(name, phone, email, password, fb_token, longitude, latitude);

  Future<LoginResponse> login(String phone, String password, String longitude, String latitude, int roleType) =>
      apiProvider.login(phone, password, longitude, latitude, roleType);

  Future<VerifyOtpResponse> verifyOtp(String phone, String otp, String userLoginID, int userID) =>
  ...
  Future<ForgotPassVerifyOtpResponse> forgotPassVerifyOtp(String phone, String otp, String userLoginID, int userID) =>
  ...
  Future<ChangePassResponse> changePassword(String oldPass, String newPass, String accessToken, int userID) =>
  ...
  Future<QualificationResponse> doctorQualification(String accessToken, int userID,
      String degree, String university, String passingYear, File regProofFile) =>
      apiProvider.doctorQualification(accessToken, userID, degree, university, passingYear, regProofFile);

  Future<RegistrationResponse> doctorRegistration(String accessToken, int userID,
      String regNumber, String regCouncil, String regDate, File regProofFile) =>
      apiProvider.doctorRegistration(accessToken, userID, regNumber, regCouncil, regDate, regProofFile);

  Future<ProfileUpdateResponse> doctorProfileUpdate(String accessToken, int userID,
      String name, String gender, String dob, String exprience, int specialityID, String hospital_address, String land_mark,
      String availability_for_home_visit, String consultation_type, String city_id,
      String state_id,
      String country_id, String bank_name, String account_holder_name,String account_number,
      String ifsc_code) =>
      apiProvider.profileUpdate(accessToken, userID, name, gender, dob, exprience, specialityID, hospital_address, land_mark,
      availability_for_home_visit, consultation_type, city_id, state_id, country_id, bank_name, account_holder_name,
      account_number, ifsc_code);

  Future<AddAppointmentScheduleResponse> addApointmentSchedule(String accessToken, int userID,
      ...
      apiProvider.addAppointmentSchedule(accessToken, userID, working_days,
          morning_time_start, morning_time_end,
        afternoon_time_start, afternoon_time_end,
        evening_time_start, evening_time_end);

  Future<AddAppointmentScheduleResponse> addApointmentScheduleTesting(String accessToken, int userID,
      String working_days, String slotType, String time_start,
      String time_end) =>
      apiProvider.addAppointmentScheduleTesting(accessToken, userID, working_days,
          slotType, time_start, time_end);
}