...
class AppointmentTSM extends StatefulWidget {
  AppointmentTSM({Key key}) : super(key: key);

  @override
  _AppointmentTSMState createState() => _AppointmentTSMState();
}

class _AppointmentTSMState extends State<AppointmentTSM> {
                            ...
                            onPressed: () async {
                              ...
                              if (fromDate != null) /*&& date != currentDate*/
                                setState(() {
                                  ...
                                  fromDateTextEditField.text =
                                      '${myFormat.format(fromSelectedDate)}';
                                });
                            },
                          ),
                        ],
                            ...
                            onPressed: () async {
                              ...
                              if (toDate != null) /* && date != selectedDate*/
                                setState(() {
                                  ...
                                  toDateTextEditField.text =
                                      '${myFormat.format(toSelectedDate)}';
                                });
                            },
                          ),
                        ],
...
Widget createTable() {
  ...
  return Table(border: TableBorder.all(color: Colors.black26), children: rows);
}
