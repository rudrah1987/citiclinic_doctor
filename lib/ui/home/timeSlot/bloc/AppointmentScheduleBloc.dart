...
class AddAppointmentBloc extends BaseBloc {
  final _addAppointmentStream = PublishSubject<AddAppointmentScheduleResponse>();
  final _loadingStream = PublishSubject<bool>();
  final _errorStream = PublishSubject<Error>();

  Stream<AddAppointmentScheduleResponse> get addAppointmentStream => _addAppointmentStream.stream;
  ...
  /*void addAppointmentSchedule(String accessToken, int userID,
    ...
    = await repository.addApointmentScheduleTesting(accessToken, userID, working_days,
