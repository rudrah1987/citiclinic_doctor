...
class _AppointmentTSPageState extends State<AppointmentTSPage> {
  ...
  TextEditingController startTimeTextFieldController = TextEditingController();
  TextEditingController endTimeTextFieldController = TextEditingController();
                      ...
                      child: DropdownButton(
                          ...
                          onChanged: (value) {
                            setState(() {
                              ...
                              print(
                                  "SessionValue :: ${_selectedSessionItem.session} :: ${_selectedSessionItem.sessionValue}");
                            });
                          }),
                    ),
                  ),
                          ...
                          Container(
                            child: Stack(
                              ...
                              children: <Widget>[
                                TextField(
                                    enabled: false,
                                    controller: startTimeTextFieldController,
                          ...
                          Container(
                            child: Stack(
                              ...
                              children: <Widget>[
                                TextFormField(
                                    enabled: false,
                                    controller: endTimeTextFieldController,
                      ...
                      onPressed: () {
                        if (_selectedDayItem == null) {
                          ...
                          Fluttertoast.showToast(
                              ...
                              backgroundColor: kBackgroundColor,
                              textColor: Colors.white);
                        } else if (startTimeTextFieldController.text.isEmpty) {
                          Fluttertoast.showToast(
                              ...
                              backgroundColor: kBackgroundColor,
                              textColor: Colors.white);
                        } else if (endTimeTextFieldController.text.isEmpty) {
                          Fluttertoast.showToast(
                        ...
                        // }
                          ...
                          _addAppointmentBloc.addAppointmentSchedule(
                            _user.accessToken,
                            _user.userId,
                            _selectedSessionItem.sessionValue.toString(),
                            _selectedDayItem.dayValue.toString(),
                            startTime,
                            endTime,
                            // fromAfternoonTime,
                            // toAfternoonTime,
    ...
    if (selectedTime != null) {
      ...
      if (formattedTime != null) {
        setState(() {
          ...
          startTimeTextFieldController.text = formattedTime;
          startTime = "${selectedTime.hour}:${selectedTime.minute}";
        });
      }
    }
  }
    ...
    if (selectedTime != null) {
      ...
      if (formattedTime != null) {
        setState(() {
          ...
          endTimeTextFieldController.text = formattedTime;
          endTime = "${selectedTime.hour}:${selectedTime.minute}:00";
        });
      }
    }
  }
