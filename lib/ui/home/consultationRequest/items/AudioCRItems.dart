...
class AudioCRItems extends StatefulWidget {
  @override
  _AudioCRItemsState createState() => _AudioCRItemsState();
}

class _AudioCRItemsState extends State<AudioCRItems> {
  @override
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          SvgPicture.asset(audioCRImage, height:32, width:32),
        ],
      ),
    );
  }
