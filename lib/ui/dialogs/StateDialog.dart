...
class _StateDialogState extends State<StateDialog> {
  ...
  onSearchTextChanged(String text) async {
    ...
    widget.stateList.forEach((searchResult) {
                  ...
                  child: new ListTile(
                    ...
                    title: new TextField(
                      ...
                      decoration: new InputDecoration(
                          hintText: 'Search state here.....', border: InputBorder.none),
                ...
                child: _searchResult.length != 0 || searchController.text.isNotEmpty
                  ...
                  itemBuilder: (context, i) {
                    return InkWell(
                      ...
                      onTap: (){
                        Navigator.pop(context, widget.stateList[i]);
                      },
                    );
                  },
                ),
